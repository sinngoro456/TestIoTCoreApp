...
class AddEventViewController: UIViewController {
    ...
    @IBAction func addNewPost(_ sender: Any) {
        ...
        appSyncClient?.perform(mutation: addEventMutation, optimisticUpdate: optimisticUpdate, resultHandler: { result, error in
            defer {
                self.navigationController?.popViewController(animated: true)

                if let eventListViewController = self.navigationController?.viewControllers.last as? EventListViewController {
